...
///     |x| x * 2
/// );
/// assert_eq!(result.await, 12); // (5 + 1) * 2
/// ```
///
/// ## Mixed operators
///
...
mod tests {
    ...
    async fn test_pipe_async_multiple_lifts() {
        ...
        assert_eq!(result.await, 15); // ((5 + 1) * 2) + 3
    }
    ...
    mod extension_tests {
        ...
        async fn comma_equals_lift(#[case] value: i32) {
            ...
            assert_eq!(result_comma.await, result_lift.await);
        }
        ...
        async fn functor_composition(#[case] value: i32) {
            ...
            assert_eq!(result_chain.await, result_composed.await);
        }
